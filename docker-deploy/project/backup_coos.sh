...
To refresh this backup, re-run docker-deploy/project/backup_coos.sh.
EOF
...
- Modifications: Security hardening snippets and helper scripts under `docker-deploy/` and `scripts/`.
